...
import Two from "../../assets/gamestaBlog.png";
import Three from "../../assets/gamestaBlog.png";
                            ...
                            <div className="blog-inline-box">
                                <div className="blog-card blog-card-blog">
                                    ...
                                    <div className="blog-table">
                                        <h4 className="blog-card-caption">
                                            <a href="#">
                                                Gamesta, A.I. powered Game-Fi guild announce private round
                                                sale
                                            </a>
                                        </h4>
                            ...
                            <div className="blog-inline-box">
                                <div className="blog-card blog-card-blog">
                                    ...
                                    <div className="blog-table">
                                        ...
                                        <h6 className="blog-category ">4 days ago</h6>
                                        <p className="blog-card-description">
                                            Gamesta ally with Venture Capitalist, ‘Meme-Masters’, Legion
                                            Ventures for marketing and community support.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        {(progress) => (
                                            <div className="">
                                                <Timeline totalProgress={progress} paused>
                                                    ...
                                                    >
                                                        <div className="">
                                                        <a href="https://twitter.com/gmestaguild" target="_blank" rel="noreferrer"><img className="twitterBox" src={twitterBox} alt="" /></a>
                                                        </div>
                                                    </Tween>
                                                </Timeline>
                                                <Timeline totalProgress={progress} paused>
                                                ...
                                                <a href="https://discord.gg/ganestaguild" target="_blank" rel="noreferrer">
                                                <Timeline totalProgress={progress} paused>
                                                    <Tween
                                                        from={{
                                                            css: {
                                                    ...
                                                    >
                                                            <img className="discordBox" src={discordBox}  alt=""/>
                                                    </Tween>
                                                </Timeline>
                                                </a>
                                                <a href="https://t.me/gamestaguild" target="_blank" rel="noreferrer">
                                                <Timeline totalProgress={progress} paused>
                                                    <Tween
                                                        from={{
                                                            css: {
                                                    ...
                                                    >
                                                        <img className="teleBox" src={telegramBox} alt="" />
                                                    </Tween>
                                                </Timeline>
                                                </a>
                                            </div>
