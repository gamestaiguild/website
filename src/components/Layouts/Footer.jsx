        ...
        <footer className="footer">
          ...
          <div className="footer-content responsive-wrapper">
            ...
            <div className="footer-column">
              ...
              <a href="#play2earn">Play 2 Earn</a>

              <a href="#business-modal">Business Model</a>
            </div>
            <div className="footer-column">
              <a href="#dao">The DAO</a>

              <a href="#eco-system">Ecosystem</a>
            ...
            <div className="footer-column">
              ...
              <a href="https://bit.ly/3jEK7yD" target="_blank" rel="noreferrer">Whitepaper</a>
            </div>
            ...
            <div className="footer-column">
              ...
              <ul className="some-list" style={{ marginLeft: 20 }}>
                ...
                <li className="some-list-item">
                  <a href="https://discord.gg/gamestaguild" target="_blank" rel="noreferrer" className="some-list-link">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                ...
                <li className="some-list-item">
                  <a href="https://twitter.com/gamestaguild" target="_blank" rel="noreferrer" className="some-list-link">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                ...
                <li className="some-list-item">
                  <a href="https://t.me/gamestaguild" target="_blank" rel="noreferrer" className="some-list-link">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
