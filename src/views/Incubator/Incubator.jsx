        ...
        <div className="project-box-wrapper incubator-project-wrapper">
          {
            projectListObj && projectListObj.map((item,index) => (
              <ProjectsList key={index} img={item.project_img} projectName={item.project_name} projectContent={item.project_content} />
            ))
          }
        </div>

      </div>
      <BlackGamexCard extraText={"Any project incubated by GAMESTA will receive a"} />
        ...
        <div className="tab-content">
          <ul>
            <li className="tab-content-list">
              ...
              <div className="tab-content-right">
                <h4>GAMESTA believes in the long term success of the projects they incubate. We prove this by not only advising, but also investing into projects we incubate. In exchange for the above services we ask for the following:</h4>
                <ul className="list">
                  <li>3.0% of token supply</li>
                  <li>5% of total raise in Stable Coin</li>
                  <li>Agreeable additional budget for marketing team, if desired.</li>
                </ul>
              </div>
            </li>
          </ul>
